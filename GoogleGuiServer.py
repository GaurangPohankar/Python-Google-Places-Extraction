...
class Begueradj(tkinter.Frame):
    ...
    def update_status(self):
        ...
        fields = ['SrNo', 'Name','Phone', 'Rating','Website', 'Address','city']
        ...
        def extrapolate_date(elements,index,driver,city):
                ...
                try:
                        ...
                        sql = "INSERT INTO google_data (Name, Phone ,Ratings ,Website ,Address) VALUES (%s, %s, %s, %s, %s)"
                        val = (str(name), str(phone),str(ratings),str(website),str(address)) 
